 ...
 * @author USER
 */
public class ClientBChat implements ActionListener,WindowListener{
    private JFrame fr;
    private JPanel p1;
...
//        ////
    ...
    public void path(ClientAChat A){
        this.A = A;
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        String temp = "["+dtf.format(LocalDateTime.now())+"]B " + text2.getText() + "\n" + text.getText();
        A.getMassage(temp);
        text.setText(temp);
        text2.setText("");
    }
